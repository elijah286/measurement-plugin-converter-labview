...
<Library LVVersion="21008000">
	...
	<Item Name="Measurement Result T4.ctl" Type="VI" URL="../../controls/Measurement Result T4.ctl"/>
	<Item Name="Measurement T4.ctl" Type="VI" URL="../../controls/Measurement T4.ctl"/>
</Library>
