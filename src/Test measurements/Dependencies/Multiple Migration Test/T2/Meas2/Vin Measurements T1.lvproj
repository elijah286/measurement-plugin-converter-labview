	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SMU" Type="Folder">
			<Item Name="subVIs" Type="Folder">
				<Item Name="Measurement T2.ctl" Type="VI" URL="../controls/Measurement T2.ctl"/>
				<Item Name="Measurement Result T2.ctl" Type="VI" URL="../controls/Measurement Result T2.ctl"/>
				<Item Name="Attenuation T2.vi" Type="VI" URL="../controls/Attenuation T2.vi"/>
			</Item>
			<Item Name="SMU T2.lvlib" Type="Library" URL="../SMU/SMU T2.lvlib"/>
		</Item>
