	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SMU" Type="Folder">
			<Item Name="subVIs" Type="Folder">
				<Item Name="Measurement Result T8.ctl" Type="VI" URL="../controls/Measurement Result T8.ctl"/>
				<Item Name="Attenuation T8.vi" Type="VI" URL="../controls/Attenuation T8.vi"/>
				<Item Name="Reusables T8.lvlib" Type="Library" URL="../Reusables/Reusables T8.lvlib"/>
				<Item Name="Configuration T8.lvlib" Type="Library" URL="../Reusables/Configuration T8.lvlib"/>
			</Item>
			<Item Name="SMU T8.lvlib" Type="Library" URL="../SMU/SMU T8.lvlib"/>
		</Item>
