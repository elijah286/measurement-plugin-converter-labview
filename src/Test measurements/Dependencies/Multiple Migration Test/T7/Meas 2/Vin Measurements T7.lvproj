	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SMU" Type="Folder">
			<Item Name="subVIs" Type="Folder">
				<Item Name="Reusables T7.lvlib" Type="Library" URL="../Reusables/Reusables T7.lvlib"/>
				<Item Name="Configuration T7.lvlib" Type="Library" URL="../Reusables/Configuration T7.lvlib"/>
			</Item>
			<Item Name="SMU T7.lvlib" Type="Library" URL="../SMU/SMU T7.lvlib"/>
		</Item>
