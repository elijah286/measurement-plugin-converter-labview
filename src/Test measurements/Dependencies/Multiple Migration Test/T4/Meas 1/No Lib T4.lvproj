	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="2 niDCPower + 2 niDMM + 1 Tektronix Scope" Type="Folder">
			<Item Name="dep" Type="Folder">
				<Item Name="Outside T4.vi" Type="VI" URL="../subVIs/Outside T4.vi"/>
				<Item Name="Temp T4.ctl" Type="VI" URL="../controls/Temp T4.ctl"/>
			</Item>
			<Item Name="DMM T4.lvlib" Type="Library" URL="../DMM/DMM T4.lvlib"/>
			<Item Name="SMU T4.lvlib" Type="Library" URL="../SMU/SMU T4.lvlib"/>
		</Item>
		<Item Name="Main T4.lvlib" Type="Library" URL="../Main T4.lvlib"/>
