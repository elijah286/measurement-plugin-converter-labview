	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="2 niDCPower + 2 niDMM + 1 Tektronix Scope" Type="Folder">
			<Item Name="dep" Type="Folder">
				<Item Name="Outside T8.vi" Type="VI" URL="../subVIs/Outside T8.vi"/>
				<Item Name="Temp T8.ctl" Type="VI" URL="../controls/Temp T8.ctl"/>
			</Item>
			<Item Name="DMM T8.lvlib" Type="Library" URL="../DMM/DMM T8.lvlib"/>
			<Item Name="SMU T8.lvlib" Type="Library" URL="../SMU/SMU T8.lvlib"/>
		</Item>
		<Item Name="Main T8.lvlib" Type="Library" URL="../Main T8.lvlib"/>
